...
public final class HeaderLayoutBinding implements ViewBinding {
  ...
  private HeaderLayoutBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView5,
  ...
  public static HeaderLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new HeaderLayoutBinding((ConstraintLayout) rootView, imageView5, textView);
    }
